...
@section('content')
    <div class="padding">
        <div class="box">
            ...
            <div class="box-body">
                {{Form::open(['route'=>['SetChild'],'method'=>'POST', 'files' => true ])}}

                <div class="form-group row">
                    <label for="image"
                           class="col-sm-2 form-control-label">{{ __('cruds.Childrens.childrenname') }}</label>
                    <div class="col-sm-10">
                        <select name="child" id="" class="form-control" required>
                            <option value="" selected disabled hidden>{{ __('cruds.Childrens.childrenname') }}</option>
