...
<script type="text/javascript">
    ...
    channel.bind('supervisor-add-vbmap', function(data) {
...
<script type="text/javascript">
    ...
    var channel = pusher.subscribe('qorb-channel');
    channel.bind('supervisor-add-treatment-plan', function(data) {
      if(data.data[1] == {{auth()->user()->id}}){
            console.log(data.data[0]);
            toastr.success(data.data[0]);
      }
...
<script type="text/javascript">
    ...
    var channel = pusher.subscribe('qorb-channel');
    channel.bind('supervisor-add-final-report', function(data) {
      if(data.data[1] == {{auth()->user()->id}}){
            console.log(data.data[0]);
            toastr.success(data.data[0]);
      }
...
<script type="text/javascript">
    ...
    var channel = pusher.subscribe('qorb-channel');
    channel.bind('supervisor-add-consulting-report', function(data) {
      if(data.data[1] == {{auth()->user()->id}}){
            console.log(data.data[0]);
            toastr.success(data.data[0]);
      }
...
<script type="text/javascript">
    ...
    var channel = pusher.subscribe('qorb-channel');
    channel.bind('specialist-add-session-report', function(data) {
      if(data.data[1] == {{auth()->user()->id}}){
            console.log(data.data[0]);
            toastr.success(data.data[0]);
      }
...
<script type="text/javascript">
    ...
    var channel = pusher.subscribe('qorb-channel');
    channel.bind('specialist-add-status-report', function(data) {
      if(data.data[1] == {{auth()->user()->id}}){
            console.log(data.data[0]);
            toastr.success(data.data[0]);
      }
...
<script type="text/javascript">
    ...
    var channel = pusher.subscribe('qorb-channel');
    channel.bind('specialist-add-consulting-report', function(data) {
      if(data.data[1] == {{auth()->user()->id}}){
            console.log(data.data[0]);
            toastr.success(data.data[0]);
      }
...
<script type="text/javascript">
    ...
    var channel = pusher.subscribe('qorb-channel');
    channel.bind('set-to-early-detection', function(data) {
      if(data.data[1] == {{auth()->user()->id}}){
            console.log(data.data[0]);
            toastr.success(data.data[0]);
      }
...
<script type="text/javascript">
    ...
    var channel = pusher.subscribe('qorb-channel');
    channel.bind('add-early-detection', function(data) {
      if(data.data[1] == {{auth()->user()->id}}){
            console.log(data.data[0]);
            toastr.success(data.data[0]);
      }
