...
class WebmasterSectionsSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $sections->title_br = "páginas do site";
        ...
        $sections->seo_title_br = "páginas do site";
        ...
        $sections->seo_url_slug_br = "sitepages";
        ...
        $sections->seo_title_br ="Serviços";
        ...
        $sections->seo_url_slug_br = "services";
        ...
        $sections->seo_title_br = "Notícias";
        ...
        $sections->seo_url_slug_br = "photos";
        ...
        $sections->seo_url_slug_br = "videos";
        ...
        $sections->seo_url_slug_br = "audio";
        ...
        $sections->seo_title_br = "Produtos";
        ...
        $sections->seo_url_slug_br = "products";
        ...
        $sections->seo_title_br = "Parceiras";
        ...
        $sections->seo_url_slug_br = "partners";
